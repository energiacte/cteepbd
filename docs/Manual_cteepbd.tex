...
\begin{itemize}
\item campo \texttt{id}, de identificación del sistema, equipo o parte asociada al componente. Si este campo no aparece se supone igual al valor `0` y normalmente se asocia al conjunto del edificio.
