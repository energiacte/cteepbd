...
De forma análoga, se podrían obtener los resultados referidos únicamente al servicio de ACS y para factores de paso considerando el perímetro próximo:
...
Y, para el cálculo teniendo en cuenta solo el servicio de ACS y el perímetro próximo:
