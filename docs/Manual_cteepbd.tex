...
\begin{itemize}
\item campo \texttt{id}, que identificación el sistema, zona o parte asociada al componente. Si este campo no aparece se supone igual al valor `0` que, normalmente, se asocia al conjunto del edificio.
